...
class TestIndex:
    ...
    @pytest.mark.parametrize("mapper", [Series(["foo", 2.0, "baz"], index=[
        0, 2, -1]), {0: "foo", 2: 2.0, -1: "baz"}], )
    ...
    def test_contains_method_removed(self, index):
        ...
        if isinstance(index, IntervalIndex):
            ...
            msg = f"'{
                type(index).__name__}' object has no attribute 'contains'"
...
@pytest.mark.parametrize("klass, extra_kwargs",
                         [[Index,
                           {}],
                             *[[lambda x: Index(x,
                                                dtype=dtyp),
