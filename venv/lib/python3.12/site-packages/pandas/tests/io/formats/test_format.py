...
class TestSeriesFormatting:
    ...
    def test_east_asian_unicode_series(self):
        ...
        s = Series([1, 22, 3333, 44444], index=[
            1, "AB", Timestamp("2011-01-01"), "あああ"])
        expected = (
            "1                          1\n"
            "AB                        22\n"
...
class TestDatetime64Formatter:
    ...
    def test_datetime64formatter_tz_ms(self):
        x = (Series(np.array(["2999-01-01", "2999-01-02", "NaT"],
                             dtype="datetime64[ms]")) .dt.tz_localize("US/Pacific") ._values)
