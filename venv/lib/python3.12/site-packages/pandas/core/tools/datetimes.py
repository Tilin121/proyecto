...
def should_cache(
        ...
        check_count: int | None = None) -> bool:
    """
...
def _adjust_to_origin(arg, origin, unit):
    ...
    if origin == "julian":
        ...
        # arg must be numeric
        if not ((is_integer(arg) or is_float(arg))
    ...
    **Timezones and time offsets**
    ...
    if infer_datetime_format is not lib.no_default:
        warnings.warn(
            ...
            "You can safely remove this argument.", stacklevel=find_stack_level(), )
    if errors == "ignore":
        # GH#54467
        warnings.warn(
            "errors='ignore' is deprecated and will raise in a future version. "
            "Use to_datetime without passing `errors` and catch exceptions "
            "explicitly instead", FutureWarning, stacklevel=find_stack_level(), )
    ...
    if isinstance(arg, Timestamp):
        ...
        try:
            ...
            # Series]"
            argc = cast(Union[list, tuple, ExtensionArray,
