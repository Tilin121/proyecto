...
class TestDataFrameUpdate:
    ...
    def test_update(self):
        ...
        expected = DataFrame([[1.5, np.nan, 3], [3.6, 2, 3], [
    ...
    def test_update_nooverwrite(self):
        ...
        expected = DataFrame([[1.5, np.nan, 3], [1.5, 2, 3], [
            1.5, np.nan, 3], [1.5, np.nan, 3.0]])
        tm.assert_frame_equal(df, expected)
    ...
    def test_update_filtered(self):
        ...
        expected = DataFrame([[1.5, np.nan, 3], [1.5, np.nan, 3], [
            1.5, np.nan, 3], [1.5, np.nan, 7.0]])
        tm.assert_frame_equal(df, expected)
    ...
    def test_update_raise_on_overlap(self):
        df = DataFrame([[1.5, 1, 3.0], [1.5, np.nan, 3.0],
                        [1.5, np.nan, 3], [1.5, np.nan, 3]])
