...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dti_add_tick_tzaware(self, tz_aware_fixture, box_with_array):
        ...
        for scalar in [
            pd.offsets.Hour(5), np.timedelta64(
                5, "h"), timedelta(
                hours=5)]:
            offset = dates + scalar
            ...
            msg = "|".join(["bad operand type for unary -",
                            "cannot subtract DatetimeArray"])
            with pytest.raises(TypeError, match=msg):
                scalar - dates
...
class TestDatetime64OverflowHandling:
    ...
    def test_dt64_series_arith_overflow(self):
        ...
        ser.iloc[-1] = NaT
        expected = Series(["2004-10-03", "2104-10-04",
                           "2204-10-04", "NaT"], dtype="datetime64[ns]")
        res = ser + td
...
class TestDatetimeIndexArithmetic:
    ...
    def test_ops_nat_mixed_datetime64_timedelta64(self):
        ...
        tm.assert_series_equal(-single_nat_dtype_timedelta +
                               datetime_series, nat_series_dtype_timestamp)
    ...
    def test_ufunc_coercions(self, unit):
        ...
        delta = np.array([np.timedelta64(1, "D"), np.timedelta64(
