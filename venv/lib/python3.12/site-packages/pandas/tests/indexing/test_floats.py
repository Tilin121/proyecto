...
class TestFloatIndexers:
    ...
    def test_slice_non_numeric(self, index, idx, frame_or_series, indexer_sli):
        ...
        if indexer_sli is tm.iloc:
            msg = (
                "cannot do positional indexing " rf"on {
                    type(index).__name__} with these indexers \[(3|4)\.0\] of " "type float")
        else:
            msg = (
    ...
    def test_slice_integer(self):
        ...
        for index, oob in [
            ...
            for idx, res1 in [
                ...
                # positional indexing
                msg = (
                    "cannot do slice indexing " rf"on {
                        type(index).__name__} with these indexers \[(2|3)\.5\] of " "type float")
                with pytest.raises(TypeError, match=msg):
                    s[idx]
