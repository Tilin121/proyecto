...
class TestDataFrameSubclassing:
    ...
    def test_indexing_sliced(self):
        # GH 11559
        df = tm.SubclassedDataFrame({"X": [1, 2, 3], "Y": [4, 5, 6], "Z": [
            7, 8, 9]}, index=["a", "b", "c"])
        res = df.loc[:, "X"]
    ...
    def test_subclass_stack(self):
        ...
        exp = tm.SubclassedSeries([1, 2, 3, 4, 5, 6, 7, 8, 9], index=[
            list("aaabbbccc"), list("XYZXYZXYZ")])
    ...
    def test_subclass_unstack(self):
        ...
        res = df.unstack()
        exp = tm.SubclassedSeries([1, 4, 7, 2, 5, 8, 3, 6, 9], index=[
            list("XXXYYYZZZ"), list("abcabcabc")])
