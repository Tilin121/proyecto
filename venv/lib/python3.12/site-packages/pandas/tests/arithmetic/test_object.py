...
class TestArithmetic:
    ...
    def test_series_with_dtype_radd_timedelta(self, dtype):
        ...
        ser = Series([pd.Timedelta("1 days"), pd.Timedelta(
            "2 days"), pd.Timedelta("3 days")], dtype=dtype, )
        expected = Series([pd.Timedelta("4 days"), pd.Timedelta(
            "5 days"), pd.Timedelta("6 days")], dtype=dtype, )
    ...
    def test_mixed_timezone_series_ops_object(self):
        ...
        exp = Series([pd.Timedelta("2 days"), pd.Timedelta(
            "4 days")], name="xxx", dtype=object)
