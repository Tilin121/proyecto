...
def _side_expander(prop_fmt: str) -> Callable:
    ...
    def expand(
            self, prop, value: str) -> Generator[tuple[str, str], None, None]:
        """
...
def _border_expander(side: str = "") -> Callable:
    ...
    def expand(
        ...
        # TODO: Can we use current color as initial value to comply with CSS
        # standards?
        border_declarations = {
        ...
        for token in tokens:
            ...
            # TODO: Warn user if item entered more than once (e.g. "border: red
            # green")
...
class CSSResolver:
    ...
    def atomize(
            self, declarations: Iterable) -> Generator[tuple[str, str], None, None]:
