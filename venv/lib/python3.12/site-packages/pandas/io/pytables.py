    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if complib is not None and complib not in tables.filters.all_complibs:
            raise ValueError(
                f"complib only supports {
                    tables.filters.all_complibs} compression.")
    ...
    def keys(self, include: str = "pandas") -> list[str]:
        ...
        if include == "pandas":
            ...
            return [
                n._v_pathname for n in self._handle.walk_nodes(
                    "/", classname="Table")]
        raise ValueError(
...
class DataCol(IndexCol):
    ...
    def __repr__(self) -> str:
        temp = tuple(map(pprint_thing, (self.name, self.cname,
...
class Selection:
    ...
    def generate(self, where):
        ...
        try:
            return PyTablesExpr(
                where, queryables=q, encoding=self.table.encoding)
