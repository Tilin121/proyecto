...
class TestDateRanges:
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize("s_ts, e_ts",
                             [("2262-02-23",
                               "1969-11-14"),
                              ("1970-02-01",
                               "1677-10-22")])
...
class TestDateRangeNonNano:
    ...
    def test_date_range_freq_matches_reso(self):
        ...
        dti = date_range(
            ...
            unit="ns")
        rng = np.arange(
            1_451_606_400_000_000_000,
            1_451_606_400_001_000_001,
            dtype=np.int64)
    ...
    def test_date_range_freq_lower_than_endpoints(self):
        ...
        rng = np.array([start.as_unit("us")._value,
                        end.as_unit("us")._value], dtype=np.int64)
...
class TestDateRangeNonTickFreq:
    ...
    def test_date_range_negative_freq_year_end(self, unit):
        ...
        exp = DatetimeIndex(["2011-12-31", "2009-12-31",
                             "2007-12-31"], dtype=f"M8[{unit}]", freq="-2YE")
        tm.assert_index_equal(rng, exp)
        assert rng.freq == "-2YE"
    ...
    def test_date_range_negative_freq_month_end(self, unit):
        ...
        exp = DatetimeIndex(["2011-01-31", "2010-11-30",
                             "2010-09-30"], dtype=f"M8[{unit}]", freq="-2ME")
        tm.assert_index_equal(rng, exp)
        assert rng.freq == "-2ME"
