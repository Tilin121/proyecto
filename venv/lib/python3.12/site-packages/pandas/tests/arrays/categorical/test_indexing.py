...
class TestCategoricalIndexingWithFactor:
    ...
    @pytest.mark.parametrize("other", [Categorical(["b", "a"]),
                                       Categorical(["b", "a"], categories=["b", "a"])], )
    ...
    def test_setitem_listlike(self):
        ...
        cat = Categorical(np.random.default_rng(2).integers(
            0, 5, size=150000).astype(np.int8)).add_categories([-1000])
...
class TestCategoricalIndexing:
    ...
    @pytest.mark.parametrize("null_val",
                             [None,
                              np.nan,
                              NaT,
                              NA,
    ...
    def test_where_ordered_differs_rasies(self):
        ser = Series(Categorical(["a", "b", "c"], categories=[
