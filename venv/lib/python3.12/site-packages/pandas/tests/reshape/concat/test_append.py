...
class TestAppend:
    ...
    def test_append_sorts(self, sort):
        ...
        # for None / True
        expected = DataFrame({"b": [1, 2, None, None], "a": [1, 2, 1, 2], "c": [
            None, None, 3, 4]}, columns=["a", "b", "c"], )
        if sort is False:
    ...
    def test_append_same_columns_type(self, index):
        ...
        expected = DataFrame([[1, 2, 3.0], [4, 5, 6], [7, 8, np.nan]], index=[
            0, 1, 2], columns=index)
        ...
        df1 = DataFrame(
            index=[
                ...
                dt.datetime(
                    ...
                    2013, 1, 2, 0, 0)], columns=["start_time"], )
        df2 = DataFrame(
            index=[
                4, 5], data=[
                [
                    dt.datetime(
                        2013, 1, 3, 0, 0), dt.datetime(
                        2013, 1, 3, 6, 10)], [
                            dt.datetime(
                                2013, 1, 4, 0, 0), dt.datetime(
                                    2013, 1, 4, 7, 10)], ], columns=[
                                        "start_time", "end_time"], )
    ...
    def test_append_empty_frame_to_series_with_dateutil_tz(self):
        ...
        expected = DataFrame([[np.nan, np.nan, 1.0, 2.0, date]], columns=[
            "c", "d", "a", "b", "date"])
    ...
    def test_append_empty_frame_with_timedelta64ns_nat(
        ...
        if isinstance(
                val,
                str) and dtype_str != "int64" and not using_array_manager:
