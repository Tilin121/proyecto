...
class TestPeriodIndexFormat:
    ...
    def test_period_non_ascii_fmt(self, locale_str):
        ...
        if locale_str is not None and not tm.can_set_locale(
                locale_str, locale.LC_ALL):
            pytest.skip(
    ...
    def test_period_custom_locale_directive(self, locale_str):
        # GH#46319 locale-specific directive leads to non-utf8 c strftime char*
        # result
