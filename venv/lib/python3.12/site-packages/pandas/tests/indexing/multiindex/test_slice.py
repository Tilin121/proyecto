...
class TestMultiIndexSlicers:
    ...
    def test_multiindex_slicers_non_unique(self):
        ...
        expected = (DataFrame({"A": ["foo", "foo"], "B": ["a", "a"], "C": [
            1, 1], "D": [1, 3]}) .set_index(["A", "B", "C"]) .sort_index())
    ...
    def test_multiindex_slicers_datetimelike(self):
        ...
        result = df.loc[(slice(Timestamp("2012-01-01 12:12:12"),
                               Timestamp("2012-01-03 12:12:12")), 1, ), slice("A", "B"), ]
        tm.assert_frame_equal(result, expected)
    ...
    def test_loc_axis_single_level_multi_col_indexing_multiindex_col_df(self):
        # GH29519
        df = DataFrame(np.arange(27).reshape(3, 9), columns=MultiIndex.from_product(
            [["a1", "a2", "a3"], ["b1", "b2", "b3"]]), )
    ...
    def test_multiindex_label_slicing_with_negative_step(self):
        ser = Series(np.arange(20), MultiIndex.from_product(
