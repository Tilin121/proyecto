...
class TestDataFramePctChange:
    ...
    def test_pct_change_with_nas(
        ...
        msg = (
            "The 'fill_method' keyword being not None and the 'limit' keyword in " f"{
                type(obj).__name__}.pct_change are deprecated")
...
def test_pct_change_with_duplicated_indices(fill_method):
    # GH30463
    data = DataFrame({0: [np.nan, 1, 2, 3, 9, 18], 1: [
        0, 1, np.nan, 3, 9, 18]}, index=["a", "b"] * 3)
