...
class TestUnique:
    ...
    def test_order_of_appearance_dt64tz(self, unit):
        ...
        expected = DatetimeIndex(
            ["2016-01-01 00:00:00"],
            dtype=f"datetime64[{unit}, US/Eastern]",
            freq=None)
        tm.assert_index_equal(result, expected)
...
class TestValueCounts:
    ...
    def test_categorical_nans(self):
        ...
        expected = Series([4, 3, 2], index=CategoricalIndex(
            ["a", "b", "c"], categories=["a", "b", "c"]), name="count", )
        tm.assert_series_equal(result, expected, check_index_type=True)
        result = s.value_counts(dropna=False)
        expected = Series([4, 3, 2, 1], index=CategoricalIndex(
            ["a", "b", "c", np.nan]), name="count")
        tm.assert_series_equal(result, expected, check_index_type=True)
    ...
    def test_value_counts_normalized(self, dtype):
        ...
        expected = Series([0.6, 0.4], index=Series(
            [2.0, 1.0], dtype=dtype), name="proportion")
        tm.assert_series_equal(result, expected)
...
class TestMode:
    ...
    def test_datelike_mode(self):
        ...
        ser = Series(["2011-01-03", "2013-01-02", "1900-05-03",
