...
class TestReadHtml:
    ...
    def test_invalid_table_attrs(self, banklist_data, flavor_read_html):
        ...
        with pytest.raises(ValueError, match="No tables found"):
            flavor_read_html(
                url, match="First Federal Bank of Florida", attrs={
                    "id": "tasdfable"})
    ...
    def test_colspan_rowspan_copy_values(self, flavor_read_html):
        ...
        expected = DataFrame(data=[["A", "B", "B", "Z", "C"]], columns=[
            "X", "X.1", "Y", "Z", "W"])
    ...
    def test_colspan_rowspan_both_not_1(self, flavor_read_html):
        ...
        expected = DataFrame(data=[["A", "B", "B", "B", "D"]], columns=[
            "A", "B", "B.1", "B.2", "C"])
    ...
    def test_displayed_only_with_many_elements(
        ...
        result = flavor_read_html(
            StringIO(html_table),
            displayed_only=displayed_only)[0]
