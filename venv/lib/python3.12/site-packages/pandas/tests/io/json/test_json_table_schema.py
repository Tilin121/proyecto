...
class TestTableOrient:
    ...
    def test_timestamp_in_columns(self):
        df = DataFrame([[1, 2]], columns=[pd.Timestamp(
            "2016"), pd.Timedelta(10, unit="s")])
                             ...
                             [pd.Index(range(4)),
                              pd.date_range("2020-08-30",
                                 ...
                                 pd.date_range("2020-08-30",
                                               freq="d",
                                               periods=4,
                                               tz="US/Central")._with_freq(None),
                                 pd.MultiIndex.from_product([pd.date_range("2020-08-30",
                                                                           freq="d",
                                                                           periods=2,
                                                                           tz="US/Central"),
                                                             ["x",
