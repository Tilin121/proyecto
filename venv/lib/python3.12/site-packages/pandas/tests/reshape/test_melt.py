...
class TestMelt:
    ...
    def test_pandas_dtypes(self, col):
        # GH 15785
        df = DataFrame({"klass": range(5), "col": col,
                        "attr1": [1, 0, 0, 0, 0], "attr2": col})
    ...
    def test_preserve_category(self):
        ...
        expected = DataFrame({"B": pd.Categorical(
            ["X", "Y"]), "variable": ["A", "A"], "value": [1, 2]})
    ...
    def test_ignore_index(self):
        ...
        expected = DataFrame({"variable": ["foo", "bar"], "value": [
            0, 1]}, index=["first", "first"])
        tm.assert_frame_equal(result, expected)
    ...
    def test_melt_with_duplicate_columns(self):
        ...
        expected = DataFrame([["id", "b", 2], ["id", "b", 3]], columns=[
            "a", "variable", "value"])
        tm.assert_frame_equal(result, expected)
    ...
    def test_melt_preserves_datetime(self):
        ...
        expected = DataFrame({"type": {0: "A0",
                                       1: "A1",
                                       2: "A0",
                                       3: "A1"},
                              "start/end": {0: "start_date",
                                            1: "start_date",
                                            2: "end_date",
                                            3: "end_date",
                                            },
                              "date": {0: pd.Timestamp("2023-03-01 00:00:00+0900",
                                                       tz="Asia/Tokyo"),
                                       1: pd.Timestamp("2023-03-01 00:00:00+0900",
                                                       tz="Asia/Tokyo"),
                                       2: pd.Timestamp("2023-03-10 00:00:00+0900",
                                                       tz="Asia/Tokyo"),
                                       3: pd.Timestamp("2023-03-11 00:00:00+0900",
                                                       tz="Asia/Tokyo"),
                                       },
                              })
        tm.assert_frame_equal(result, expected)
...
class TestWideToLong:
    ...
    def test_non_unique_idvars(self):
        ...
        df = DataFrame({"A_A1": [1, 2, 3, 4, 5], "B_B1": [
