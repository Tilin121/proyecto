...
def _cat_compare_op(op):
    ...
    def func(self, other):
        ...
        if hashable:
            ...
            if isinstance(
                    other,
                    ExtensionArray) and needs_i8_conversion(
                    other.dtype):
...
class Categorical(
    ...
    def _from_inferred_categories(
        ...
        known_categories = (
            isinstance(
                dtype,
                CategoricalDtype) and dtype.categories is not None)
    ...
    @classmethod
    def _validate_codes_for_dtype(cls, codes, *
    , dtype: CategoricalDtype) -> np.ndarray:
