...
class TestGroupBy:
    ...
    def test_timegrouper_with_reg_groups_freq(self, freq):
        ...
        result1 = (df.sort_index().groupby(
            [Grouper(freq=freq), "user_id"])["whole_cost"].sum())
    ...
    def test_groupby_groups_datetimeindex2(self):
        ...
        dates = [
            ...
            "2015-01-02",
            "2015-01-01"]
        expected = {Timestamp(date): DatetimeIndex(
            [date], name="date") for date in dates}
    ...
    def test_groupby_multi_timezone(self):
        ...
        expected = Series(
            [
                Timestamp(
                    "2000-01-28 16:47:00-0600",
                    tz="America/Chicago"),
                Timestamp(
                    "2000-01-29 16:48:00-0600",
                    tz="America/Chicago"),
                Timestamp(
                    "2000-01-30 16:49:00-0800",
                    tz="America/Los_Angeles"),
                Timestamp(
                    "2000-01-31 16:50:00-0600",
                    tz="America/Chicago"),
                Timestamp(
                    "2000-01-01 16:50:00-0500",
                    tz="America/New_York"),
            ],
            name="date",
            dtype=object,
