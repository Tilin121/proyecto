...
class TestDataFrameAnalytics:
    ...
    def test_stat_op_api_float_string_frame(
        ...
        if (
            ...
            if opname in ["var", "std", "sem", "skew", "kurt"]:
                ...
                msg = re.compile(
                    r"Cannot convert \[.*\] to numeric|does not support",
                    flags=re.S)
    ...
    @pytest.mark.parametrize("df",
                             [DataFrame({"a": [-0.00049987540199591344,
    ...
    @pytest.mark.xfail(using_pyarrow_string_dtype(),
                       reason="sum doesn't work for arrow strings")
                                 ...
                                 (False,
                                  {"A": [12],
                                   "B": [10.0],
                                      ...
                                      "D": np.array([np.nan],
                                                    dtype=object),
                                      "E": Categorical([np.nan],
                                                       categories=["a"]),
                                      "F": DatetimeIndex([pd.NaT],
                                                         dtype="M8[ns]"),
                                  ...
                                  {"H": [8,
                                   ...
                                   "I": [8,
                                      ...
                                      "K": Categorical(["a",
                                                        ...
                                                        np.nan],
                                                       categories=["a"]),
                                      "L": DatetimeIndex(["2000-01-02",
                                                          "NaT",
                                                          "NaT",
                                                          "NaT"],
                                                         dtype="M8[ns]"),
                                      "M": to_timedelta(["1 days",
                                                         "nan",
                                                         "nan",
                                                         "nan"]),
                                      "N": [0,
    ...
    def test_sum_mixed_datetime(self):
        # GH#30886
        df = DataFrame({"A": date_range("2000", periods=4),
                       "B": [1, 2, 3, 4]}).reindex([2, 3, 4])
