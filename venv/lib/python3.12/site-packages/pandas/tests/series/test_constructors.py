...
class TestSeriesConstructors:
    ...
    def test_constructor_dtype_datetime64_10(self):
        ...
        expected = Series([NaT, datetime(2013, 1, 2), datetime(
            2013, 1, 3)], dtype="datetime64[ns]")
    ...
    def test_constructor_dtype_timedelta_ns_s_astype_int64(self):
        # GH#35465
        result = Series([1000000, 200000, 3000000],
                        dtype="timedelta64[ns]").astype("int64")
        expected = Series([1000000, 200000, 3000000],
                          dtype="timedelta64[s]").astype("int64")
        tm.assert_series_equal(result, expected)
    ...
    def test_constructor_mismatched_null_nullable_dtype(
        ...
        # GH#44514
        msg = "|".join(["cannot safely cast non-equivalent object",
