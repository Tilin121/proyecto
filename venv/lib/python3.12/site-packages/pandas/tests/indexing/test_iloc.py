...
class TestiLocBaseIndependent:
    ...
    def test_iloc_exceeds_bounds(self):
        ...
        dfl = DataFrame(
            np.random.default_rng(2).standard_normal(
                (5, 2)), columns=list("AB"))
        tm.assert_frame_equal(dfl.iloc[:, 2:3], DataFrame(
            index=dfl.index, columns=Index([], dtype=dfl.columns.dtype)), )
    ...
    def test_iloc_non_integer_raises(
            ...
            column_vals):
        # GH 25753
        df = DataFrame(np.random.default_rng(2).standard_normal(
    ...
    def test_setitem_mix_of_nan_and_interval(self, not_na, nulls_fixture):
        ...
        ser = Series([nulls_fixture, nulls_fixture,
                      nulls_fixture, nulls_fixture], dtype=dtype)
...
class TestILocSetItemDuplicateColumns:
    ...
    def test_iloc_setitem_dtypes_duplicate_columns(
        ...
        # GH#22035
        df = DataFrame([[init_value, "str", "str2"]],
                       columns=["a", "b", "b"], dtype=object)
