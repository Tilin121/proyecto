        ...
        if (is_list_like(level) and len(level) == 1) or (  # type: ignore[arg-type]
            ...
            if isinstance(name, tuple) and len(name) == 1:
                ...
                warnings.warn(
                    ...
                    "this warning.", FutureWarning, stacklevel=find_stack_level(), )
    ...
    **Attributes**
    ...
    def quantile(
        ...
        def pre_processor(
            ...
            if isinstance(
                    vals, BaseMaskedArray) and is_numeric_dtype(
                    vals.dtype):
        ...
        def post_processor(
            ...
            if inference:
                ...
                if isinstance(orig_vals, BaseMaskedArray):
                    ...
                    if interpolation in {
                            "linear", "midpoint"} and not is_float_dtype(orig_vals):
    ...
    def shift(
        ...
        if is_list_like(periods):
            ...
            if not is_integer(periods):
                raise TypeError(
                    f"Periods must be integer, but {periods} is {
                        type(periods)}.")
            if suffix:
                raise ValueError(
...
def _insert_quantile_level(idx: Index,
                           qs: npt.NDArray[np.float64]) -> MultiIndex:
    """
