...
class TestPeriodDisallowedFreqs:
    ...
    def test_custom_business_day_freq_raises(self):
        ...
        msg = f"{
            offsets.CustomBusinessDay().base} is not supported as period frequency"
        with pytest.raises(ValueError, match=msg):
