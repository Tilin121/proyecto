...
class TestMergeMulti:
    ...
    def test_left_join_multi_index(self, sort, infer_string):
        with option_context("future.infer_string", infer_string):
            ...
            left.insert(
                1, "2nd", np.random.default_rng(2).integers(
    ...
    def test_merge_multiple_cols_with_mixed_cols_index(self):
        # GH29522
        s = Series(range(6), MultiIndex.from_product(
            [["A", "B"], [1, 2, 3]], names=["lev1", "lev2"]), name="Amount", )
    ...
    def test_merge_datetime_index(self, klass):
        # see gh-19038
        df = DataFrame([1, 2, 3], ["2016-01-01", "2017-01-01",
                                   "2018-01-01"], columns=["a"])
...
class TestJoinMultiMulti:
    ...
    def test_single_common_level(self):
        ...
        left = DataFrame({"A": ["A0", "A1", "A2"], "B": [
            "B0", "B1", "B2"]}, index=index_left)
