...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def _from_categorical_dtype(
            ...
            categories=None,
            ordered: Ordered | None = None) -> CategoricalDtype:
    ...
    def _get_common_dtype(self, dtypes: list[DtypeObj]) -> DtypeObj | None:
        ...
        non_init_cats = [
            isinstance(
                x,
                CategoricalDtype) and x.categories is None for x in dtypes]
        ...
        non_cat_dtypes = [x.categories.dtype if isinstance(
            x, CategoricalDtype) else x for x in dtypes]
...
class DatetimeTZDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def __init__(
            self,
            unit: str_type | DatetimeTZDtype = "ns",
            tz=None) -> None:
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_from_string(cls, string: str_type) -> PeriodDtype:
        ...
        if isinstance(string, str):
            ...
            msg = f"'construct_from_string' expects a string, got {
                type(string)}"
        raise TypeError(msg)
...
class IntervalDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def __init__(
            self,
            subtype=None,
            closed: IntervalClosedType | None = None) -> None:
...
class BaseMaskedDtype(ExtensionDtype):
    ...
    def _get_common_dtype(self, dtypes: list[DtypeObj]) -> DtypeObj | None:
        ...
        new_dtype = find_common_type([dtype.numpy_dtype if isinstance(
            dtype, BaseMaskedDtype) else dtype for dtype in dtypes])
