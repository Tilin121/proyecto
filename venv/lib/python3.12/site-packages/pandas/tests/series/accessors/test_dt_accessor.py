...
class TestSeriesDatetimeValues:
    ...
    def test_dt_namespace_accessor_datetime64(self, freq):
        ...
        exp_values = (DatetimeIndex(ser.values).tz_localize(
    ...
    def test_dt_namespace_accessor_index_and_values(self):
        ...
        exp = Series(np.array([2014, 2014, 2014],
                              dtype="int32"), index=index, name="xxx")
    ...
    def test_dt_tz_convert_categorical(self, tz_aware_fixture):
        # GH 27952
        tz = tz_aware_fixture
        datetimes = Series(["2019-01-01", "2019-01-01",
                            "2019-01-02"], dtype="datetime64[ns, MET]")
        categorical = datetimes.astype("category")
    ...
    def test_strftime(self):
        ...
        expected = Series(["2013/01/01", "2013/01/02",
    ...
    def test_dt_timetz_accessor(self, tz_naive_fixture):
        ...
        ser = Series(dtindex)
        expected = Series([time(23, 56, tzinfo=tz), time(
