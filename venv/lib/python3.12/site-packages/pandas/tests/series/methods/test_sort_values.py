...
class TestSeriesSortValues:
    ...
    def test_sort_values_categorical(self):
        ...
        expected = Series(Categorical(
            ["a", "a", "b", "b"], ordered=False), index=[0, 3, 1, 2])
        ...
        raw_cat1 = Categorical(["a", "b", "c", "d"], categories=[
            "a", "b", "c", "d"], ordered=False)
        raw_cat2 = Categorical(
            ["a", "b", "c", "d"], categories=["d", "c", "b", "a"], ordered=True
        )
        s = ["a", "b", "c", "d"]
        df = DataFrame({"unsort": raw_cat1, "sort": raw_cat2,
        ...
        # multi-columns sort
        # GH#7848
        df = DataFrame({"id": [6, 5, 4, 3, 2, 1], "raw_grade": [
            "a", "b", "b", "a", "a", "e"]})
